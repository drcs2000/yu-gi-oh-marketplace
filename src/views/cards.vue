          ...
          <div class="card-back">
            <div class="card-content">
              ...
              <div class="flex justify-center mt-4">
                <button @click="addCard(card.id)" class="flex items-center justify-center  bg-[#857100] rounded-lg px-3 py-1 text-sm transition-all duration-300 hover:bg-black hover:border-[#FFD700]">
